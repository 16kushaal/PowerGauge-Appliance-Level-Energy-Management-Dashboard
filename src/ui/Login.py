...
"\n"
"QPushButton:enabled {\n"
"  background-color: #8b5cf6; /* Yellow shade */\n"
...
"}")
        ...
        # Create horizontal container for password input and toggle button
        self.passwordContainer = QtWidgets.QHBoxLayout()
        self.passwordContainer.setSpacing(0)
        self.passwordContainer.setContentsMargins(0, 0, 0, 0)  # Remove any container margins
        ...
        self.btnTogglePassword = QtWidgets.QPushButton(parent=self.framePassword)
        self.btnTogglePassword.setMaximumWidth(30)
        self.btnTogglePassword.setStyleSheet("""
            QPushButton {
                border: none;
                border-radius: 0px;
                background-color: white;
        ...
        # Add password field and toggle button to container
        self.passwordContainer.addWidget(self.inputPassword)
        self.passwordContainer.addWidget(self.btnTogglePassword)
        
        # Add the container to the vertical layout
        self.verticalLayout_2.addLayout(self.passwordContainer)
        
        # Connect toggle button functionality
        self.btnTogglePassword.clicked.connect(self.togglePasswordVisibility)
    ...
    def retranslateUi(self, LoginPage):
        ...
        LoginPage.setWindowTitle(_translate("LoginPage", "Login - PowerGauge"))
    ...
    def togglePasswordVisibility(self):
        if self.inputPassword.echoMode() == QtWidgets.QLineEdit.EchoMode.Password:
            self.inputPassword.setEchoMode(QtWidgets.QLineEdit.EchoMode.Normal)
